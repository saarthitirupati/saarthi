...
/**
 * Authentic concise Telugu meanings corresponding 1-to-1 with each of the 108 sacred beads.
 */
export const TELUGU_SHORT_MEANINGS: string[] = [
  "పాపాలను పరిహరించే వేంకటాద్రి నాథుడు",
  "లక్ష్మీదేవి హృదయమందు కొలువైన శ్రీనివాసుడు",
  "మహాలక్ష్మీపతి, సర్వ సంపత్ప్రదాత",
  "సర్వ రోగ నివారిణి, దివ్య వైద్యుడు",
  "అమృతత్వ ప్రదాత, అమృత స్వరూపుడు",
  "సకల లోకాలచే పూజింపబడే లోకనాథుడు",
  "సర్వ జీవుల రక్షకుడు, గోవిందుడు",
  "శాశ్వతుడు, నిత్య సత్య పరబ్రహ్మం",
  "సర్వశక్తిమంతుడైన జగత్ప్రభువు",
  "శేషాద్రి శిఖరాన కొలువైన స్వామి",
  "స్వయంప్రకాశ దివ్య తేజోమూర్తి",
  "త్రిమూర్తి స్వరూపుడైన పరమాత్ముడు",
  "అజ్ఞానాన్ని, అరిషడ్వర్గాలను నాశనం చేసేవాడు",
  "నిత్య అమృత స్వరూపుడు",
  "జ్ఞాన ప్రదాత, లక్ష్మీ సమేత మాధవుడు",
  "కాలాతీతుడు, సత్య నిత్యుడు",
  "అపరిమిత పరాక్రమవంతుడు",
  "జ్ఞాన ఖడ్గ నందకధరుడు",
  "దివ్య శార్ఙ్గ ధనుర్ధారి",
  "కౌమోదకీ గదాధరుడు",
  "పాంచజన్య శంఖధరుడు",
  "దివ్య సుదర్శన చక్రధారి",
  "సృష్టి మూలమైన పద్మనాభుడు",
  "భక్తి పాశాలకు బద్ధుడైన దామోదరుడు",
  "సర్వోన్నత పరబ్రహ్మ స్వరూపం",
  "భక్తులను సంసార సాగరం దాటించే నాథుడు",
  "సకల దుఃఖాలను నశింపజేసేవాడు",
  "భక్తుల దోషాలను క్షమించే దయామయుడు",
  "నిత్య శుద్ధుడు, పాపరహితుడు",
  "దివ్య కరుణామయుడు",
  "భక్తుల సర్వ భయాలను హరించేవాడు",
  "అనంత గుణ సంపన్నుడు",
  "అద్భుతమైన జగన్నాటక సూత్రధారి",
  "పరిపూర్ణ ఆనంద స్వరూపుడు",
  "శరణాగత రక్షకుడు, దీనబంధువు",
  "సర్వోత్కృష్ట మోక్షదాత",
  "భక్తుల మనస్సులను ఆకర్షించే సుందరుడు",
  "సర్వ సమర్థుడు, సర్వవ్యాపి",
  "నిర్మల పవిత్ర స్వరూపుడు",
  "పాపాలనే అంధకారాన్ని నశింపజేసేవాడు",
  "భక్త రక్షకుడు, అభయ ప్రదాత",
  "సర్వోన్నత పురుషోత్తముడు",
  "సర్వ కళ్యాణ గుణాకరుడు",
  "దివ్య సౌభాగ్య ప్రదాత",
  "నిత్య శుభకరుడు, ఉత్సవ ప్రియుడు",
  "మోక్షాన్ని, పరమ శాంతిని ప్రసాదించేవాడు",
  "అఖిలాండ కోటి బ్రహ్మాండ నాయకుడు",
  "నిరంతరం లోకాన్ని కాపాడే జగద్రక్షకుడు",
  "అపార కరుణా సముద్రుడు",
  "భవబంధాలను, సంసార తాపాలను నశింపజేసేవాడు",
  "ప్రసన్న చిరునవ్వులు చిందించే దివ్యముఖుడు",
  "సర్వ శుభాలను అనుగ్రహించే దేవుడు",
  "సాక్షాత్ శ్రీమహావిష్ణు స్వరూపుడు",
  "సకల జీవులకు పరమ ఆశ్రయమైన నారాయణుడు",
  "పవిత్ర తిరుమల కొండపై కొలువైనవాడు",
  "సప్తగిరి వాసుడు, ఏడుకొండలవాడు",
  "గరుడ వాహనారూఢుడైన స్వామి",
  "సమస్త విశ్వానికి సర్వసత్తాక చక్రవర్తి",
  "అమృతతుల్యమైన మధుర భాషణుడు",
  "భక్తులకు సదా తోడుగా నిలిచే సహాయకుడు",
  "గజేంద్రుని రక్షించి మోక్షమిచ్చిన కరివరదుడు",
  "భక్త ప్రహ్లాదుని కాపాడిన దైవం",
  "ముల్లోకాలకు అధిపతి అయిన త్రైలోక్యనాథుడు",
  "వేదాల ద్వారా తెలియబడే పరమ సత్యం",
  "సకల యజ్ఞాలకు అధిపతి, యజ్ఞపురుషుడు",
  "ప్రశాంతమైన అంతఃశాంతిని ప్రసాదించేవాడు",
  "దివ్య తేజస్సుతో ప్రకాశించే తేజోమయుడు",
  "సమ్మోహన దివ్యమంగళ విగ్రహుడు",
  "కౌస్తుభ మణిధరుడైన శ్రీహరి",
  "సుగంధ వనమాలాధరుడు",
  "బంగారు పీతాంబరధారి",
  "అభయాలను, వరాలను కురిపించే వరదహస్తుడు",
  "సంసార సముద్రం మోకాటి లోతేనని అభయమిచ్చే కటిహస్తుడు",
  "బంగారు ఆనందనిలయంలో కొలువైనవాడు",
  "స్వర్ణ శిఖరాల నీడన విలసిల్లే దైవం",
  "పవిత్ర స్వామి పుష్కరిణి తీరాన కొలువైనవాడు",
  "ఆదివరాహ క్షేత్రంలో నివాసమున్న స్వామి",
  "శంఖ చక్రాలను ధరించిన శ్రీమహావిష్ణువు",
  "సమ్మోహన దివ్య సుందర ముఖారవిందుడు",
  "ముల్లోకాలను మూడడుగులతో కొలిచిన త్రివిక్రముడు",
  "శాంత మూర్తి అయిన వామనావతారుడు",
  "భయాలను పారద్రోలే శ్రీ నరసింహస్వామి",
  "ధర్మమూర్తి అయిన శ్రీరామచంద్రుడు",
  "ప్రేమామృత స్వరూపుడైన శ్రీకృష్ణ పరమాత్ముడు",
  "కలియుగ ప్రత్యక్ష దైవమైన శ్రీ వేంకటేశ్వరుడు",
  "సర్వ భయాలను, ఆందోళనలను పోగొట్టేవాడు",
  "సకల సత్సంకల్పాలను నెరవేర్చే దేవుడు",
  "కీర్తించినంతనే పుణ్యమిచ్చే పుణ్యశ్లోకుడు",
  "సత్కీర్తిని, సదాచారాన్ని ప్రసాదించేవాడు",
  "సంపూర్ణ ఆయురారోగ్యాలను ప్రసాదించే ధన్వంతరి",
  "సద్బుద్ధిని, ఉత్తమ విద్యను ప్రసాదించేవాడు",
  "అఖండ సౌభాగ్యాలను అనుగ్రహించే దైవం",
  "నిత్య సత్య పరబ్రహ్మ స్వరూపుడు",
  "అంతర్యామి, సమస్తాన్ని తెలిసిన సర్వజ్ఞుడు",
  "సమస్త విశ్వశక్తులకూ మూలమైన సర్వశక్తిమంతుడు",
  "అణువణువునా నిండియున్న సర్వవ్యాపి",
  "నిష్కల్మష భక్తితో సులభంగా లభించే సులభుడు",
  "అనన్య భక్తితో మాత్రమే పొందగలిగేవాడు",
  "శరణన్న వారిని కంటికి రెప్పలా కాపాడేవాడు",
  "దివ్య వేంకటాద్రికి ఏకైక ప్రభువు",
  "ఏడుకొండలకు ఏలిక అయిన సప్తగిరినాథుడు",
  "సమస్త విశ్వాన్ని తనయందే ఇముడ్చుకున్న విశ్వరూపుడు",
  "నిత్యానంద, చైతన్య స్వరూపుడైన పరమాత్ముడు",
  "సర్వ జీవుల హృదయాలలో కొలువైన పరమాత్మ",
  "అఖిల లోకాలకు పాలకుడైన జగన్నాథుడు",
  "ముల్లోకాలను పవిత్రం చేసే లోకపావనుడు",
  "సర్వమంగళ ప్రదాత, శుభస్వరూపుడు",
  "శ్రీ పద్మావతీ సమేత సాక్షాత్ పరబ్రహ్మ స్వరూపం"
];

/**
 * Returns the localized short meaning for a bead (Telugu or English).
 */
export function getNamaShortMeaning(beadNumber: number, lang: 'te' | 'en'): string {
  const index = Math.max(0, Math.min(GOVINDA_NAMAVALI.length - 1, (beadNumber - 1) % GOVINDA_NAMAVALI.length));
  if (lang === 'te') {
    return TELUGU_SHORT_MEANINGS[index] || '';
  }
  const rawEn = GOVINDA_NAMAVALI[index].namaEn;
  const match = rawEn.match(/^(.*?)\s*\((.*?)\)\s*$/);
  return match ? match[2].trim() : rawEn;
}
