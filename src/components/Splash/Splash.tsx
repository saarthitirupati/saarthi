    ...
    <AnimatePresence onExitComplete={onFinish}>
      {isVisible && (
        <motion.div
          ...
          style={{
            background: 'radial-gradient(circle at 50% 40%, #073827 0%, #031D14 65%, #010D09 100%)'
          }}
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <circle cx="160" cy="85" r="28" fill="none" stroke="#D4AF37" strokeWidth="1" strokeDasharray="2 3" opacity="0.8" />
                  ...
                  <circle cx="160" cy="85" r="3.5" fill="#FDE047" style={{ filter: 'drop-shadow(0 0 6px #FDE047)' }} />
                </motion.g>
                ...
                >
                  <line x1="160" y1="102" x2="132" y2="165" stroke="#E5B246" strokeWidth="1.6" />
                  <line x1="160" y1="102" x2="188" y2="165" stroke="#E5B246" strokeWidth="1.6" />
                  ...
                  <path d="M 152 122 C 156 128 164 128 168 122" fill="none" stroke="#E5B246" strokeWidth="1" opacity="0.8" />
                  <path d="M 143 137 C 151 144 169 144 177 137" fill="none" stroke="#E5B246" strokeWidth="1" opacity="0.8" />
                </motion.g>
                ...
                <path d="M 108 268 Q 160 286 212 268" fill="none" stroke="#D4AF37" strokeWidth="1.2" strokeDasharray="2.5 3.5" opacity="0.8" />
                <path d="M 116 282 Q 160 296 204 282" fill="none" stroke="#D4AF37" strokeWidth="1.2" strokeDasharray="2.5 3.5" opacity="0.8" />
