...
export default function EditPlace({ params }: { params: Promise<{ id: string }> }) {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => { setToast(''); router.push('/saarthiadmin/places'); }, 1800);
  };
  ...
  return (
    ...
    >
      ...
      <div className={styles.topRow}>
        ...
        <Link href="/saarthiadmin/places" className={styles.btnSecondary}><ArrowLeft size={15} /> Back</Link>
      </div>
      ...
      <form onSubmit={submit}>
        ...
        <div className={styles.formActions}>
          <Link href="/saarthiadmin/places" className={styles.btnSecondary}>Cancel</Link>
