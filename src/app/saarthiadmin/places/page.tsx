...
export default function AdminPlacesList() {
  ...
  const categories = useMemo(() => {
    // Filter out empty/null/undefined categories so they don't appear as blank options
            ...
            {filteredPlaces.map(place => {
              ...
              return (
                <tr key={place.id}>
                  ...
                  <td>
                    <span style={{ fontSize: '12px', fontWeight: 600, padding: '3px 8px', borderRadius: '6px', background: '#F1F5F9', color: '#334155', whiteSpace: 'nowrap' }}>
                      {place.category || <span style={{ color: '#CBD5E1', fontStyle: 'italic' }}>Uncategorized</span>}
                    </span>
                  </td>
                  <td>
                    <span style={{ 
